...
mbc2 <- function(..., times=5, input, inputi, evaluator, post, target, targetin,
  ...
  for (j in 1:times) {
    ...
    for (i in 1:n) {
      ...
      # print("runtime is"); print(runtime)
  ...
  out_list <- list()
  class(out_list) <- c("mbc2", class(out_list))
